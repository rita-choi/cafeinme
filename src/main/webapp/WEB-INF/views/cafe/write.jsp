							...
							<div class="box-body">
								<div class="form-group">
									<label for="cafename">카페명</label> <input class="form-control"
										id="cafename" name="cafename" placeholder="카페명을 입력 해 주세요" readonly>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="locationAddr">검색</label> <input class="form-control"
										id="locationAddr" name="locationAddr">
										<input type="button" onclick="searchAddress()" value="주소 검색"><br>

									<div class="map_wrap">
<div id="map" style="width:500px;height:400px;position:relative;overflow:hidden;;margin-top:10px;display:none"></div>
    <ul id="category">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.substr(12, 2) == "s_") {
                        ...
                        console.log("이미지파일 전송 성공");
                        
                    // 이미지 파일이 아닐 경우
                    } else {
                        html = templateFileAttach(fileInfo);
                        console.log("일반파일 전송 성공");
