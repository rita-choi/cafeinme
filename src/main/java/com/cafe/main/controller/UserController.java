...
import com.cafe.main.domain.LoginDTO;
...
import com.cafe.main.service.UserService;
...
*/
    ...
    public String profile(HttpSession session, Model model) throws Exception {
        ...
        List<CafeListVO> cafelists = cafelistService.userCafeList(uid);
        List<ReviewVO> userReviews = reviewService.userReviews(uid);
        List<BookmarkVO> bookmarkList = bookmarkService.list(uid);

        model.addAttribute("cafelists", cafelists);
